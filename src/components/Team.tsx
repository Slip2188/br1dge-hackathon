...
export default function Team() {
  ...
  const teamMembers = [
    ...
    {
      name: "Prisha Pachpore",
      role: "Co-Founder",
      bio: "With a blend of creativity and logic, she bridges the gap between ideas and execution. Prisha helps shape our hackathon’s strategy and growth with a keen eye for opportunity and a heart for collaboration",
      image: Prisha,
      social: {
        github: "#",
        linkedin: "#",
    ...
    },
    {
      ...
      bio: "With a passion for storytelling and a keen eye for aesthetic, Labdhi brings our hackathon’s narrative to life through our socials",
      image: Labdhi,
      social: {
        github: "#",
        linkedin: "#",
    ...
    },
    {
      ...
      role: "Design Head",
      bio: "With a flair for creativity and a knack for user experience, Nakshatra crafts digital solutions that inspire and engage",
      image: Naksh,
      social: {
        github: "#",
        linkedin: "#",
